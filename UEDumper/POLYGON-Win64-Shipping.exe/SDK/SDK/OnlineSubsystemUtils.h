...
class UOnlineEngineInterfaceImpldup_7 : public UOnlineEngineInterface
{ 
public:
...
static_assert(sizeof(UOnlineEngineInterfaceImpldup_7) == 0x0180); // 384 bytes (0x000028 - 0x000180)
